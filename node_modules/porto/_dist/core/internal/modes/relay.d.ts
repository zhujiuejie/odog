...
export declare function relay(parameters?: relay.Parameters): import("../types.js").Assign<Mode.Mode, {
    readonly actions: {
        ...
        readonly grantAdmin: (parameters: {
            account: Account.Account;
            internal: Mode.ActionsInternal;
            feeToken?: import("../schema/token.js").Symbol | import("ox/_types/core/Address.js").Address | undefined;
            key: Key.from.Value;
        }) => Promise<{
            key: {
                expiry: number;
        ...
        readonly prepareCalls: (parameters: {
            ...
            account: Account.Account<"privateKey" | "porto">;
            capabilities: {
                quote: any;
            ...
            digest: `0x${string}`;
            key: Pick<Key.Key, "type" | "publicKey" | "prehash">;
            typedData: {
